...
namespace UzTube.DataAccess.Persistence.Migrations
{
    ...
    [Migration("20251108085517_Added_Table_CategoryTranslate")]
    partial class Added_Table_CategoryTranslate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UzTube.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("11111111-1111-1111-1111-111111111111"),
                            CreatedOn = new DateTime(2025, 11, 8, 8, 55, 16, 429, DateTimeKind.Utc).AddTicks(4030),
