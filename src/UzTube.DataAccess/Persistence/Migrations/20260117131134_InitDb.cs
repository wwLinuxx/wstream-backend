    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                FullName = table.Column<string>(type: "character varying(25)", unicode: false, maxLength: 25, nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            {
                Id = table.Column<Guid>(type: "uuid", nullable: false),
                Username = table.Column<string>(type: "character varying(20)", unicode: false, maxLength: 20, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                FollowedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                Id = table.Column<Guid>(type: "uuid", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                PreviewUrl = table.Column<string>(type: "character varying(1000)", unicode: false, maxLength: 1000, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                Id = table.Column<Guid>(type: "uuid", nullable: false),
                UserId = table.Column<Guid>(type: "uuid", nullable: false),
                StreamKey = table.Column<string>(type: "character varying(16)", unicode: false, maxLength: 16, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                UserId = table.Column<Guid>(type: "uuid", nullable: false),
                CommentText = table.Column<string>(type: "character varying(1500)", unicode: false, maxLength: 1500, nullable: false),
                CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_PlaylistsPosts", x => x.Id);
                table.ForeignKey(
                    name: "FK_PlaylistsPosts_Playlists_PlaylistId",
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_Ratings", x => new { x.Id, x.PostId, x.UserId });
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_CommentLikes", x => new { x.Id, x.CommentId, x.UserId });
                table.ForeignKey(
        ...
        migrationBuilder.CreateIndex(
            name: "IX_PlaylistsPosts_PlaylistId",
