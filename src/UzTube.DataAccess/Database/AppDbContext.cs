...
public class AppDbContext : DbContext
{
    ...
    internal DbSet<UserFollower> UserFollowers { get; set; }
    internal DbSet<UserProfile> UserProfiles { get; set; }
    internal DbSet<UserCountry> UserCountries { get; set; }
    internal DbSet<UserPlaylist> UserPlaylists { get; set; }
    internal DbSet<Post> Posts { get; set; }
    internal DbSet<PostView> PostViews { get; set; }
    internal DbSet<PostLike> PostLikes { get; set; }
    internal DbSet<PostComment> PostComments { get; set; }
    internal DbSet<PostCommentLike> PostCommentLikes { get; set; }
    internal DbSet<Category> Categories { get; set; }
    internal DbSet<PostCategory> PostCategories { get; set; }
    internal DbSet<PlaylistPost> PlaylistsPosts { get; set; }
    internal DbSet<PostRating> PostRatings { get; set; }
